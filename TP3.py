...
afu = "C:\\Users\\joakn\\Documents\\GitHub\\TP3-AyED\\USUARIOS.dat"
alu = open (afu, "w+b")
regUser = user()
...
afl = "C:\\Users\\joakn\\Documents\\GitHub\\TP3-AyED\\LOCALES.dat"
all = open (afl, "w+b")
regLoc = locales()
...
afp = "C:\\Users\\joakn\\Documents\\GitHub\\TP3-AyED\\PROMOCIONES.DAT"
alp = open (afp, "w+b")
regProm = promociones()
...
afup = "C:\\Users\\joakn\\Documents\\GitHub\\TP3-AyED\\USO_PROMOCIONES.DAT"
#alup = open (afup, "w+b")
...
afn = "C:\\Users\\joakn\\Documents\\GitHub\\TP3-AyED\\NOVEDADES.DAT"
#aln = open (afn, "w+b")
regNov = novedades()
...
def valid_cli():
    global opccli
    opccli = input ("\nOPCION: ")
    while opccli != "1" and opccli != "2" and opccli != 3 and opccli != "0":
        opccli = input("Mal ingresado. Repetir opción. OPCIÓN: ")
    clear_screen()
#----------------------------CASE-----------------------------
def select_menu(m):
    match m:
...
def busca_descuento():
    ...
    codigo = input("Ingrese un codigo de local: ")
    while (codigo != regProm.codLocal):
        input("Codigo invalido vuelva a ingresarlo: ")
    fecha = input("Ingrese una fecha: ")
    while(fecha < fecha_actual):
        input("Fecha no válida, volver a ingresarla: ")   
