...
regProm.fechaDesdePromo=datetime.datetime.strptime("07/10/2023","%d/%m/%Y")
regProm.fechaHastaPromo=datetime.datetime.strptime("07/11/2023","%d/%m/%Y")
regProm.diasSemana=matrix
